...
{
    //One instance for simple use case multiple can be used also
    public static AudioController instance;

    public bool debug;
    public AudioTrack[] tracks;

    private Hashtable m_AudioTable;         //this creates a relationship been audio types (key) and audio tracks (value)
    public Hashtable m_JobTable;            //this creates a relationship been audio types (key) and jobs (value)
    ...
    private void RemoveJob(AudioType _type)
    {
        ...
        {
            LogWarning($"Trying to remove a job {_type} that is not running.");
            return;
        }
